...
data class Velocity(var x: Double = 0.0, var y: Double = 0.0, var z: Double = 0.0)

data class Rotation(var yaw: Float = 0.0f, var pitch: Float = 0.0f)

data class Transform(var position: Position = Position(), var rotation: Rotation = Rotation())
