...
private fun encodeNbtInternal(
    ...
    when (tag) {
        ...
        is Nbt.DoubleTag -> {
            sink.writeDouble(tag.value)
        }

        is Nbt.FloatTag -> {
            sink.writeFloat(tag.value)
        }
        ...
        is Nbt.LongTag -> {
            sink.writeLong(tag.value)
        }

        is Nbt.ShortTag -> {
            sink.writeShort(tag.value)
        }
